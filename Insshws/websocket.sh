...
cd
wget -O /usr/local/bin/edu-proxy https://raw.githubusercontent.com/Azigaming404/Autoscript-by-azi/main/Insshws/dropbear-ws.py.txt && chmod +x /usr/local/bin/edu-proxy
