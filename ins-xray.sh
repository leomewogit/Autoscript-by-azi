...
mkdir -p /home/vps/public_html
wget -q -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/Azigaming404/Autoscript-by-azi/main/vps.conf.txt"

wget -q -O xraymode.sh https://raw.githubusercontent.com/Azigaming404/Autoscript-by-azi/main/Xray%20mode/xraymode.sh && chmod +x xraymode.sh && ./xraymode.sh
sleep 1 
