...
echo -e "${GREEN}=========================================="
echo -e "Payload Direct Worryfree 8080" 
echo -e "=================================================="
echo -e "GET /worryfree HTTP/1.1[crlf]host: tsel.me[crlf]Connection: keep-alive[crlf]Upgrade: websocket[crlf][crlf]"
echo -e "=================================================="
