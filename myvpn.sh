...
sleep 1
wget -q -O ins-xray.sh https://raw.githubusercontent.com/Azigaming404/Autoscript-by-azi/main/tes/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
sleep 1
...
sleep 1
echo "Installing ssh websocket & slowdns" | lolcat
