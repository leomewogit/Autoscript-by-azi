...
sleep 1
wget -q -O ins-xray.sh https://raw.githubusercontent.com/Azigaming404/Autoscript-by-azi/main/autoscript-ssh-slowdns-main/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
sleep 1
