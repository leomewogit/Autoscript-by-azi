...
wget -q -O /usr/bin/autoreboot "https://raw.githubusercontent.com/Agunxzzz/XrayCol/main/minacantik/autoreboot.sh"
wget -q -O /usr/bin/restart "https://raw.githubusercontent.com/Agunxzzz/XrayCol/main/minacantik/restart.sh"
wget -q -O /usr/bin/tendang "https://raw.githubusercontent.com/Agunxzzz/XrayCol/main/minacantik/tendang.sh"
...
wget -q -O /usr/bin/menu-vless "https://raw.githubusercontent.com/Agunxzzz/XrayCol/main/minacantik/menu-vless.sh"
wget -q -O /usr/bin/menu-vmess "https://raw.githubusercontent.com/Agunxzzz/XrayCol/main/minacantik/menu-vmess.sh"
#wget -q -O /usr/bin/menu-socks "https://raw.githubusercontent.com/Agunxzzz/XrayCol/main/minacantik/menu-socks.sh"
wget -q -O /usr/bin/menu-ss "https://raw.githubusercontent.com/Agunxzzz/XrayCol/main/minacantik/menu-ss.sh"
wget -q -O /usr/bin/menu-trojan "https://raw.githubusercontent.com/Agunxzzz/XrayCol/main/minacantik/menu-trojan.sh"
...
wget -q -O /usr/bin/backup "https://raw.githubusercontent.com/Azigaming404/Autoscript-by-azi/main/menu-backup.sh"
